    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                ...
                <form:form action="/optimization_time/swjy_update" modelAttribute="transactionOfThings"  id="admin-form" name="addForm">
                        ...
                        <div class="section row">
                            <div class="col-md-6">
                                <label for="id" class="field prepend-icon">
                                    <form:input path="id" cssClass="gui-input" placeholder="事件id..." readonly="true" />
