...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/reception/mb/css/mswzl.css">
            ...
            <a href="/mb_seconds/swzl_page">
                <div class="swxz">
                    <img src="<%=request.getContextPath()%>/static/reception/mb/img/swxz_gray.png" width="22.454px"
                         height="21.5px">
                    <span class="nav_keywords_orange">失物寻找</span>
                </div>
            </a>
        </li>
        <li>
    ...
    <div class="event_home">
        <div class="event">
            ...
            <%--<div class="task_all">
                ...
                <!-- 查看更多start -->
                <div class="The_more">
                    <a class="swzl_pagination" href="javascript:void(0);" onclick="pagination()">
