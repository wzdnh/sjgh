            ...
            <div class="task_all">
                <div class="money_event">
                    ...
                    <div class="small_event_home">
                        <span class="event_keyword">${sessionScope.lostAndFound.event_tags}</span>
                ...
                <div class="description_img">
                    <img src="${sessionScope.lostAndFound.road}" width="180px" height="163px">
                </div>
                <div class="exhibition_details_footer">
                    <div class="user_imformation">
                        <img src="${sessionScope.lostAndFound.user_er.head_portrait}" width="32px" height="32px">
