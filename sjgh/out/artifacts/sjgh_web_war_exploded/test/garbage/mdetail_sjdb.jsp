...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/static/reception/mb/garbage/mdetail.css">
    <title>任务详情_事件代办</title>
</head>
            ...
            <div class="task_all">
                <div class="money_event">
                    ...
                    <div class="small_event_home">
                        ...
                        <img src="<%=request.getContextPath()%>/static/reception/mb/imgs/tags.png" width="19px" height="19px">
                    </div>
                </div>
                ...
                <div class="exhibition_details_footer">
                    <div class="user_imformation">
                        ...
                        <div class="Name_LegalTimes">
                            <span class="name">${sessionScope.agentEvent.username}</span>
